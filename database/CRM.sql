...
CREATE INDEX idx_control_points_account ON control_points(account_id);
...
-- Расширения для агрегации и внешних интеграций
...
-- Client Invite Tokens (Инвайты для регистрации клиентов в портале)
-- =========================================================
...
-- =========================================================
-- HSE module + Safety Briefings (added 2026-05-26)
-- See database/migrations/hse_and_safety_briefings.sql
-- =========================================================
...
-- ===========================================
-- Share links: внешние UUID-ссылки на сущности (read-only)
-- ===========================================
