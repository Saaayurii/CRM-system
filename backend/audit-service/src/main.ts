...
async function bootstrap() {
  ...
  const config = new DocumentBuilder().setTitle('Audit Service API').setDescription('Audit/Event Log API for Construction CRM').setVersion('1.0').addBearerAuth().build();
