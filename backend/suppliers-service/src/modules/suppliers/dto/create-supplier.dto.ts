...
export class CreateSupplierDto {
  ...
  @ApiProperty({ description: 'Supplier name', example: 'ООО СтройМатериалы' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(255)
  name: string;
  ...
  @ApiPropertyOptional({ description: 'Phone', example: '+7 (495) 123-45-67' })
  @IsString()
  @IsOptional()
  @MaxLength(50)
  phone?: string;
  ...
  @ApiPropertyOptional({ description: 'Delivery time in days', example: 7 })
  @IsNumber()
  @IsOptional()
  deliveryTimeDays?: number;

  @ApiPropertyOptional({ description: 'Minimum order amount', example: 10000 })
  @IsNumber()
  @IsOptional()
