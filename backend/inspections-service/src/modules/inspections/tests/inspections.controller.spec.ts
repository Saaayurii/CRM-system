...
describe('InspectionsController', () => {
  ...
  let service: jest.Mocked<InspectionsService>;
  ...
  describe('findById', () => {
    it('should call service.findById', async () => {
      service.findById.mockResolvedValue(mockInspection);
  ...
  describe('create', () => {
    it('should call service.create with accountId and dto', async () => {
      ...
      service.create.mockResolvedValue(mockInspection);
  ...
  describe('update', () => {
    it('should call service.update', async () => {
      ...
      service.update.mockResolvedValue({ ...mockInspection, title: 'Updated' });
