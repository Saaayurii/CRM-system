...
describe('DefectsService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should pass status and projectId filters', async () => {
      ...
      expect(repository.findAll).toHaveBeenCalledWith(1, 1, 20, 1, 3, undefined, undefined);
    });
  });
  ...
  describe('delete', () => {
    it('should delete a defect', async () => {
      ...
      expect(result).toEqual({
        message: 'Defect with ID 1 deleted successfully',
      });
  ...
  describe('deleteTemplate', () => {
    it('should delete a template', async () => {
      ...
      expect(result).toEqual({
        message: 'Defect template with ID 1 deleted successfully',
      });
    });
