        ...
        <div className="space-y-8">
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Corporate Wiki — Корпоративная ВИКИ */}
              <li className="mb-1 last:mb-0">
                <NavLink href="/dashboard/wiki-pages" className={linkCls(pathname.startsWith('/dashboard/wiki-pages'))}>
                  <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                  </svg>
                  <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 duration-200">Корпоративная ВИКИ</span>
                </NavLink>
              </li>

              {/* Construction Wiki — Строительная ВИКИ */}
              <li className="mb-1 last:mb-0">
                <NavLink href="/dashboard/wiki" className={linkCls(pathname.startsWith('/dashboard/wiki') && !pathname.startsWith('/dashboard/wiki-pages'))}>
                  <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
