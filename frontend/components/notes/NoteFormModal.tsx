  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/40 p-4" onClick={onClose}>
      ...
      >
        ...
        <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Заголовок (необязательно)</label>
        <input
          value={title}
        ...
        <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Текст</label>
        <textarea
          value={content}
          onChange={(e) => setContent(e.target.value)}
          rows={4}
          placeholder="Что нужно сделать / о чём напомнить"
        ...
        <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Цвет стикера</label>
