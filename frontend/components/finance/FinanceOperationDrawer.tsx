...
<div style="text-align:right;margin-bottom:16px">
  <button onclick="window.print()" style="padding:8px 16px;background:#5b21b6;color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:13px">{t('🖨 Печать')}</button>
</div>
<div class="header">
...
<div class="signatures">
  <div class="sig">
    ...
    <div class="sig-label">{t('Руководитель / подпись')}</div>
  </div>
  <div class="sig">
    <div class="sig-line"></div>
    <div class="sig-label">{t('Бухгалтер / подпись')}</div>
  </div>
  <div class="sig">
    <div class="sig-line"></div>
    <div class="sig-label">{t('Кассир / подпись')}</div>
  </div>
</div>
<div class="footer-note">{t('Документ сформирован автоматически. Требует подписи уполномоченного лица.')}</div>
</body>
</html>`;
}
            ...
            <dl className="grid grid-cols-2 gap-x-6 gap-y-3">
              ...
              {op.description && (
                <div className="col-span-2">
                  <dt className="text-xs text-gray-400 dark:text-gray-500 mb-0.5">{t('Назначение / комментарий')}</dt>
            ...
            <div className="space-y-2">
              {isIncome ? (
                <DocButton
                  ...
                  title={t('Приходный кассовый ордер (ПКО)')}
                  description={t('Форма КО-1 — подтверждение приёма наличных')}
                ...
                <DocButton
                  ...
                  title={t('Расходный кассовый ордер (РКО)')}
                  description={t('Форма КО-2 — подтверждение выдачи наличных')}
              ...
              <DocButton
                ...
                title={t('Квитанция')}
                description={t('Подтверждение операции для контрагента')}
