...
/** Вертикальный градиент для режима «по всему чату»: один градиент натянут на
 *  всю высоту переписки. Цвет пузыря зависит от его места в ленте — верхние
 *  (старые) сообщения у первого цвета, нижние (свежие) у последнего, между
 *  ними — плавный переход (как в Telegram). */
