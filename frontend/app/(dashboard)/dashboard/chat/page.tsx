...
export default function ChatPage() {
  ...
  return (
    <div ref={chatContainerRef} className={`flex ${mobileClass} lg:h-dvh lg:-mx-8 lg:-my-8 lg:w-[calc(100%+4rem)] sm:max-lg:h-[calc(100dvh-64px)] sm:max-lg:-mx-6 sm:max-lg:-my-8 sm:max-lg:w-[calc(100%+3rem)] bg-[#e9e9e9] dark:bg-gray-900 max-lg:rounded-none shadow-xs overflow-hidden overscroll-none`}>
