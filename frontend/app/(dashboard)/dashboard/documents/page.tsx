          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700/50">
              {loading ? (
                ...
                <tr>
                  <td colSpan={5} className="px-4 py-8 text-center text-gray-400">Документы не найдены</td>
                </tr>
              ) : (
                documents.map((doc) => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-lg w-full p-6">
            ...
            <div className="flex items-center gap-3 mb-4">
              <span className="text-2xl">{typeIcons[previewDoc.documentType || ''] || typeIcons.other}</span>
              <div>
                <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">{previewDoc.title}</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="space-y-3">
              {previewDoc.description && (
                <div>
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300">{previewDoc.description}</p>
                </div>
              )}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full ${statusColors[previewDoc.status || ''] || statusColors.draft}`}>
                ...
                <div>
                  <p className="text-xs font-medium text-gray-400 dark:text-gray-500 uppercase mb-1">Размер</p>
