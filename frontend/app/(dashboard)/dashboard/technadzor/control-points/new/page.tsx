    ...
    <div className="px-4 sm:px-6 lg:px-8 py-6 w-full max-w-9xl mx-auto">
      ...
      <div className="mb-6 flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-1">
          ...
          <button onClick={() => save('draft')} disabled={saving} title={t('Сохранить черновик')} className="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700/40 transition disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {step < STEPS.length ? (
            ...
            <button onClick={() => save('active')} disabled={saving} title={t('Опубликовать пункт')} className="p-2 rounded-lg text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-500/10 transition disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
